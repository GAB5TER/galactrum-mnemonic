...
var Mnemonic = function(data, wordlist) {
  ...
  if (Buffer.isBuffer(data)) {
    ...
    throw new orecore.errors.InvalidArgument('data', 'Must be a Buffer, a string or an integer');
  }
  ent = ent || 128;
  ...
  if (ent % 32 !== 0 || ent < 128) {
    throw new orecore.errors.InvalidArgument('ENT', 'Values must be ENT > 128 and ENT % 32 == 0');
  }
...
Mnemonic.prototype.toHDPrivateKey = function(passphrase, network) {
  ...
  return orecore.HDPrivateKey.fromSeed(seed, network);
};
