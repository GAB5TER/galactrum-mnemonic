...
This will generate a file `dist/orecore-mnemonic.js`, which can be included into your HTML a-like so:

```html
<html lang="en">
<head>
  <title>Tester - Galactrum Mnemonic</title>
  <script language="javascript" src="dist/orecore-mnemonic.js"></script>
</head>
<body>
  <script>
